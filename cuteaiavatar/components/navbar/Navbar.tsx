...
const Navbar = () => {
  return (
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            {links.map((link) => (
            <Link className="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" href={link.url} key={link.id}>
                {
                    link.title
                }
            </Link>))}
